...
public interface SymbolTable {
    ...
    default String print() {
        ...
        for (var method : methods) {
            ...
            List<List<Symbol>> realparams = new ArrayList<>();
            ...
            for(var param: params){
                if(param != null){
                    ...
                    realparams.add(auxlist);
                    auxlist = new ArrayList<>();
                }
            }
            for(var actualParams : realparams){
                builder.append(" - " + returnType.print() + " " + method + "(");
                var paramsString = actualParams.stream().map(param -> param != null ? param.print() : "<null param>")
